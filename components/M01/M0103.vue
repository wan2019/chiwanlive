...
<section class="box">
  <div class="box__item">
    <v-row id="service" class="service">
      <v-col cols="12">
        <br>
      ...
      <v-col v-for="(item, i) in list2" cols="12" sm="6" md="3" :key="`list2${i}`"  class="test__red">
...
<script>
import ImgBox from '~/components/general/ImgBoxM0103'
      ...
      list2: [
        {
          ...
          text: ['網路直播 線下活動','線上直播 直播節目就像經過後製'],
          aosDelay: 1,
        },
        {
